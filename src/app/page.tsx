          ...
          <div className="grid md:grid-cols-2 gap-6">
            <FadeInScale delay={0.1}>
              <div className="glow-card rounded-2xl p-8 h-full">
                ...
                <ul className="space-y-4 text-mist text-[0.9375rem] leading-relaxed">
                  <li className="flex gap-3"><span className="text-amber/60 shrink-0 mt-0.5">✕</span>Every person uses different tools to reach clients</li>
                  <li className="flex gap-3"><span className="text-amber/60 shrink-0 mt-0.5">✕</span>New hires take 3 weeks to learn &ldquo;how we do things&rdquo;</li>
                  <li className="flex gap-3"><span className="text-amber/60 shrink-0 mt-0.5">✕</span>You can&apos;t see what&apos;s happening without asking everyone</li>
                  <li className="flex gap-3"><span className="text-amber/60 shrink-0 mt-0.5">✕</span>Clients fall through cracks between tools</li>
                  <li className="flex gap-3"><span className="text-amber/60 shrink-0 mt-0.5">✕</span>Paying for 10 subscriptions, using pieces of each</li>
                </ul>
              </div>
            </FadeInScale>
            ...
            <FadeInScale delay={0.2}>
              <div className="glow-card rounded-2xl p-8 border-cyan/10 h-full">
                ...
                <ul className="space-y-4 text-mist text-[0.9375rem] leading-relaxed">
                  <li className="flex gap-3"><span className="text-cyan shrink-0 mt-0.5">→</span>One inbox for all client communication</li>
                  <li className="flex gap-3"><span className="text-cyan shrink-0 mt-0.5">→</span>New hire productive in days, not weeks</li>
                  <li className="flex gap-3"><span className="text-cyan shrink-0 mt-0.5">→</span>One dashboard — see everything at a glance</li>
                  <li className="flex gap-3"><span className="text-cyan shrink-0 mt-0.5">→</span>Nothing falls through the cracks</li>
                  <li className="flex gap-3"><span className="text-cyan shrink-0 mt-0.5">→</span>One app to open in the morning</li>
                </ul>
              </div>
            </FadeInScale>
          </div>
      ...
      <section id="solution" className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.1}>
            {[{icon:"M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128Zm0 0a15.998 15.998 0 0 0 3.388-1.62m-5.043-.025a15.994 15.994 0 0 1 1.622-3.395m3.42 3.42a15.995 15.995 0 0 0 4.764-4.648l3.876-5.814a1.151 1.151 0 0 0-1.597-1.597L14.146 6.32a15.996 15.996 0 0 0-4.649 4.763m3.42 3.42a6.776 6.776 0 0 0-3.42-3.42",title:"Built for you",desc:"Not a generic platform. Software designed around YOUR workflow, YOUR team, YOUR business. Tailored like a suit."},{icon:"M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 7.5h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z",title:"Enterprise inside",desc:"Built on Microsoft Dynamics 365 — the same platform Fortune 500 companies use. Scaled for your 10-person team."},{icon:"M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z",title:"You own it",desc:"No lock-in. Full documentation. Any consultant can maintain it. It's YOUR system, forever."},{icon:"M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z",title:"AI where it helps",desc:"Smart routing, classification, and automation in the background. Humans stay in control where judgment matters."},{icon:"M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z",title:"Discovery first",desc:"We study how you work before we build anything. You see the ROI before committing a dollar."},{icon:"M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5",title:"We lived the pain",desc:"10 years inside law firms, immigration offices, and tourism companies. We didn't read about this — we lived it."}].map((feature) => (
      ...
      <section id="process" className="relative py-32 px-6 overflow-hidden border-t border-white/[0.04]">
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <StaggerContainer className="grid sm:grid-cols-2 gap-6" staggerDelay={0.12}>
            {[{num:"01",step:"1",title:"Discovery",desc:"We audit your current tools, map your actual workflow, and identify what can become one system. You see the ROI before committing."},{num:"02",step:"2",title:"Build",desc:"We design and build your unified application. Custom UI, automated workflows, AI where it helps — all on enterprise infrastructure."},{num:"03",step:"3",title:"Launch & Train",desc:"We deploy, train your team, and make sure everyone is using it. The system works on Monday morning."},{num:"04",step:"4",title:"Evolve",desc:"Your business changes. Your app changes with it. Monthly support, new features, and continuous improvement."}].map((item) => (
      ...
      <section id="verticals" className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6" staggerDelay={0.1}>
            {[{icon:"M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52 2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 0 1-2.031.352 5.988 5.988 0 0 1-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.97ZM5.25 4.97 7.87 15.696c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 0 1-2.031.352 5.989 5.989 0 0 1-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.97Z",title:"Law Firms",desc:"Case management, client comms, documents, deadlines"},{icon:"M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418",title:"Immigration",desc:"Case lifecycle, documents, status updates, compliance"},{icon:"M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 7.5h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z",title:"Tourism",desc:"Bookings, guest comms, operations, pricing — unified"},{icon:"M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z",title:"Services",desc:"Intake, scheduling, delivery, invoicing — one flow"}].map((v) => (
        ...
        <FadeInScale className="max-w-3xl mx-auto relative z-10 text-center">
          <div className="glow-card rounded-3xl p-12 md:p-16 border-cyan/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <GlowButton href="/contact" variant="primary" className="text-lg">
                Book a Discovery Call
              </GlowButton>
